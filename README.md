...
The goal of this project is to build a simple video game where you create and control creatures that can attack each other.  
It is designed to practice object-oriented programming, especially inheritance: a base `Creature` class defines shared data and an `attack()` method, while multiple child classes extend `Creature` to add their own stats and behaviors.
